 ...
 *  Remarks
 *  -------
 *    -  don't use AffineTransform for re-scaling since it inverts
 *       images and strings;
...
public final class StandardDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
	...
	// singleton for callback: avoids generation of extra .class files
    ...
    *************************************************************************/
    ...
    public static void main(String[] args) {
        StandardDraw.square(.2, .8, .1);
        StandardDraw.filledSquare(.8, .8, .2);
        StandardDraw.circle(.8, .2, .2);

        StandardDraw.setPenColor(StandardDraw.BOOK_RED);
        StandardDraw.setPenRadius(.02);
        StandardDraw.arc(.8, .2, .1, 200, 45);

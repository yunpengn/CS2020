...
public class HighwayTestPartOne {
	...
	public void testZero() {
		Highway highway = new Highway(2, 2);
		boolean caught = false;
		try {
	...
	public void testZeroCustomers() {
		...
		boolean caught = false;
		try {
			assertEquals("Range 20 yields 0 stations.", 0, highway.numberOfStations(20));
	...
	public void testBoundaries() {
		...
		try {
			highway.addCustomer(2);
			assertEquals("Range 20 yields 1 stations.", 1, highway.numberOfStations(20));			
			assertEquals("Range 0 yields 1 stations.", 1, highway.numberOfStations(0));
		}
		catch(IllegalArgumentException e){
			caught = true;			
		}
	...
	public void testBoundariesTwo() {
		...
		try {
			...
			assertEquals("Range 20 yields 2 stations.", 2, highway.numberOfStations(20));			
			assertEquals("Range 500 yields 1 stations.", 1, highway.numberOfStations(500));
			assertEquals("Range 0 yields 2 stations.", 2, highway.numberOfStations(0));
		}
		catch(IllegalArgumentException e){
			caught = true;			
		}
